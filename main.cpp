...
{
	auto twoCards = CreateTwoCards();
	using row_t = array<bool, 52>;
	using matrix_t = array<row_t, 52>;
	matrix_t m;
	for (auto r = 0; r < 52; ++r)
		for (auto c = 0; c < 52; ++c)
			m[r][c] = false;
	for (auto& twoCard : twoCards)
		m[twoCard.first][twoCard.second] = true;
	...
	set<int> cs;
	map<int, map<int, bool>> m2;
	for (auto& twoCard : twoCards)
	{
		cs.insert(twoCard.second);
		m2[twoCard.first][twoCard.second] = true;
	}
	cout << "Reduced:\n";
	for (auto& r : m2)
	{
...
/*
11111111100000000000000000000000000
01111111100000000000000000000000000
00111111100000000000000000000000000
00011111100000000000001000000010000
00001111100100010000100100001000100
00000111111011100011010000110101000
00000011111011111111010111110101111
00000001100000110000001100000010100
00000000100000101000000010000000010
00000000000000100100000001000000001
00000000001011100011010000110101000
00000000000011100011010000110101000
00000000000000000000001000000010000
00000000000001100011010000110101000
00000000000000100011010000110101000
00000000000000011111010111110101111
00000000000000000000001100000010100
00000000000000000000000010000000010
00000000000000000000000001000000001
00000000000000000001010000110101000
00000000000000000000010000110101000
00000000000000000000001000000010000
00000000000000000000000000110101000
00000000000000000000000100001000100
00000000000000000000000000000010100
00000000000000000000000000000000010
00000000000000000000000000000000001
00000000000000000000000000010101000
